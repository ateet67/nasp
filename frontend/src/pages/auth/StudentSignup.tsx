...
export default function StudentSignup() {
  ...
  const [signupMutation, { isLoading: loading, error: mutationError }] = useSignupMutation()
  ...
  return (
    <AuthLayout title="Join the Conservation Program" subtitle="Create your student account">
