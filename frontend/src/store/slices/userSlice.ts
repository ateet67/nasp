...
export const selectSearchTerm = (state: { users: UserState }) => state.users.searchTerm
export const selectSelectedRole = (state: { users: UserState }) => state.users.selectedRole
...
export const selectShowAddModal = (state: { users: UserState }) => state.users.showAddModal
export const selectShowDeleteModal = (state: { users: UserState }) => state.users.showDeleteModal
export const selectShowEditModal = (state: { users: UserState }) => state.users.showEditModal
