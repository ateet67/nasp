...
const studentSlice = createSlice({
  ...
  reducers: {
    ...
    setCurrentConservation: (
      state,
      action: PayloadAction<Conservation | null>
    ) => {
    ...
    setAssessmentAnswer: (
      ...
      state.assessmentAnswers[action.payload.questionIndex] =
    ...
    updateConservationProgress: (
      state,
      action: PayloadAction<{ conservationId: string; progress: any }>
    ) => {
      const conservation = state.conservations.find(
        (c) => c._id === action.payload.conservationId
      );
      if (conservation) {
    ...
    updateTopicProgress: (
      state,
      action: PayloadAction<{ topicId: string; completed: boolean }>
    ) => {
...
export const selectConservations = (state: { student: StudentState }) =>
  state.student.conservations;
export const selectAchievements = (state: { student: StudentState }) =>
  state.student.achievements;
export const selectTotalProgress = (state: { student: StudentState }) =>
  state.student.totalProgress;
export const selectCurrentConservation = (state: { student: StudentState }) =>
  state.student.currentConservation;
export const selectCurrentTopic = (state: { student: StudentState }) =>
  state.student.currentTopic;
export const selectCurrentItems = (state: { student: StudentState }) =>
  state.student.currentItems;
export const selectCurrentAssessment = (state: { student: StudentState }) =>
  state.student.currentAssessment;
export const selectBadges = (state: { student: StudentState }) =>
  state.student.badges;
export const selectNotifications = (state: { student: StudentState }) =>
  state.student.notifications;
export const selectUnreadNotificationCount = (state: {
  student: StudentState;
}) => state.student.unreadNotificationCount;
export const selectStudentLoading = (state: { student: StudentState }) =>
  state.student.isLoading;
export const selectStudentError = (state: { student: StudentState }) =>
  state.student.error;
export const selectShowAssessmentModal = (state: { student: StudentState }) =>
  state.student.showAssessmentModal;
export const selectShowBadgeModal = (state: { student: StudentState }) =>
  state.student.showBadgeModal;
export const selectShowNotificationModal = (state: { student: StudentState }) =>
  state.student.showNotificationModal;
export const selectAssessmentAnswers = (state: { student: StudentState }) =>
  state.student.assessmentAnswers;
export const selectAssessmentSubmitted = (state: { student: StudentState }) =>
  state.student.assessmentSubmitted;
export const selectAssessmentResult = (state: { student: StudentState }) =>
  state.student.assessmentResult;
